...
<td><?= $a ['title']?></td>
<td> 
<a href="edit_article.php?action=edit&id=<?=$a['id']?>">Редактировать</a> 
</td>
<td>
<a href="articles_admin.php?action=delete&id=<?=$a['id']?>">Удалить</a>
</td>
</tr>
<?php endforeach ?>
...
{
addArticle($_POST['id'],$_POST['title'],$_POST['intro'],$_POST['full']);
